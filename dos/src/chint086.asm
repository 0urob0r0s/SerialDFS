; serdfs/dos/src/chint086.asm
; Copied verbatim from vendor/etherdfs-baseline/etherdfs/trunk/chint086.asm
; EtherDFS by Mateusz Viste, MIT licence. See COPYING and NOTICES.
; Original assembly from OpenWatcom 1.9 (bld/clib/intel/a/chint086.asm),
; Sybase Open Watcom Public Licence version 1.0.
